    ...
    if(ponentesInput){
        ...
        function mostrarPonentes(){
            ...
            if(ponentesFiltrados.length > 0){
                ...
                noResultados.classList.add('listado-ponentest__no-resultado');
        ...
        function seleccionarPonente (e){
            ...
            const ponentePrevia = document.querySelector('.listado-ponentes__ponente--select');
            if(ponentePrevia){
                ponentePrevia.classList.remove('listado-ponentes__ponente--select');
            }
